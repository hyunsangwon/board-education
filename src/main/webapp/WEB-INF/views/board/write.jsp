            ...
            <div class="table-responsive">		
				<div class="form-group">
					...
					<div class="col-md-4">
						...
						<c:if test="${FLAG == 'V'}">
							<input autocomplete="off"  type="text" class="form-control" id="title" name="title" value="${boardVO.title}">
						</c:if>
					</div>
					<!--content -->
					...
					<div class="col-md-4">
						...
						<c:if test="${FLAG == 'V'}">
							<textarea cols="35" rows="10" class="form-control" id="content" name="content">${boardVO.content}</textarea>
						</c:if>
					</div>
					<!--submit -->
